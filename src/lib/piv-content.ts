export const pivStats = [
  { value: 23, prefix: "+", suffix: " años", label: "liderando la recuperación de materiales en El Salvador" },
  { value: 1000, prefix: "+", suffix: " millones", label: "de libras recuperadas históricamente" },
...
export const preparationSteps = ["Limpios", "Secos", "Separados"];

export const activeCampaigns = ["Recicla y Gana", "Campañas Empresariales", "Campañas Educativas"];
...
export const faqs = [
  {
    ...
    answer:
      "Recibimos plásticos, metales, papel, cartón y una amplia variedad de residuos electrónicos. Algunos materiales requieren disposición responsable por cobro según su condición y manejo.",
  },
  {
    question: "¿Realizan recolecciones?",
    answer:
      "Sí. Diseñamos rutas para empresas, campañas y solicitudes específicas según volumen, ubicación y tipo de material.",
  },
  {
    question: "¿Cómo funciona el certificado de destrucción?",
    answer:
      "Documentamos el proceso de destrucción y disposición con evidencia y trazabilidad para respaldar auditorías y cumplimiento interno.",
  },
  {
    question: "¿Qué materiales tienen costo de disposición?",
    answer:
      "Materiales contaminados, mezclados o ciertos RAEE pueden requerir cobro por su manejo responsable. El equipo comercial evalúa cada caso.",
  },
  {
    question: "¿Trabajan con empresas?",
    answer:
      "Sí. Atendemos empresas, corporaciones, industrias y centros comerciales con soluciones integrales, reportes y acompañamiento operativo.",
  },
  {
...
export const emailLink = { label: "comunicaciones@parqueindustrialverde.com", href: "mailto:comunicaciones@parqueindustrialverde.com" };

export const whatsappHref = "https://wa.me/50379484108";
