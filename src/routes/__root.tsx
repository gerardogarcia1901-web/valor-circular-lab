...
import { organizationSchema, siteDescription, siteName } from "@/lib/piv-seo";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://parqueindustrialverde.com/images/piv-logo.png" },
      { property: "og:image:alt", content: "Parque Industrial Verde" },
      { name: "twitter:image", content: "https://parqueindustrialverde.com/images/piv-logo.png" },
    ],
    links: [
      { rel: "icon", type: "image/png", href: "/images/piv-logo.png" },
      { rel: "shortcut icon", type: "image/png", href: "/images/piv-logo.png" },
      { rel: "apple-touch-icon", href: "/images/piv-logo.png" },
